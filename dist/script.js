...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.dropdown = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(`[data-toggel-id="${id}"]`).fadeToggle(300);
    });
  }
};
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-toggel="modal"]').modal();
...
Object(_lib_core__WEBPACK_IMPORTED_MODULE_1__["default"])('#first').on('click', () => {
  Object(_lib_core__WEBPACK_IMPORTED_MODULE_1__["default"])('div').eq(1).fadeToggle(800);
});
Object(_lib_core__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-count="second"] ').on('click', () => {
  Object(_lib_core__WEBPACK_IMPORTED_MODULE_1__["default"])('div').eq(2).fadeToggle(800);
});
...
Object(_lib_core__WEBPACK_IMPORTED_MODULE_1__["default"])('#trigger').click(() => Object(_lib_core__WEBPACK_IMPORTED_MODULE_1__["default"])('#trigger').createModal({
  text: {
    title: 'Modal title',
    body: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.' + ' Aliquid consectetur cum doloribus error eveniet explicabo incidunt ipsum' + ' laboriosam laborum molestiae nihil officiis perferendis perspiciatis possimus praesentium quas repellat, sequi sit?'
  },
  btns: {
    count: 3,
...
Object(_lib_core__WEBPACK_IMPORTED_MODULE_1__["default"])().get('https://jsonplaceholder.typicode.com/todos/1').then(res => console.log(res));
